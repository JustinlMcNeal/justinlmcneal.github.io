-- Flag listings marked active in DB but missing a seller offer (no price / not buyable).
...
COMMENT ON VIEW public.v_amazon_listing_workspace IS
  'Denormalized Amazon listing workspace. Profit, compare, health, FBA/FBM, missing-offer detection.';
