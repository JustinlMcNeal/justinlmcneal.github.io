...
import { renderCartItems, getCartEls, updateCartRecommendations } from "./cartUI.js";
...
export async function renderCartDrawer() {
  ...
  // Load recommendations asynchronously (BOGO hints, pairs well, best sellers)
  const activePromos = totals.activePromos || [];
  updateCartRecommendations(items, activePromos, els);
}
