-- Phase 5F: FBA vs FBM fulfillment labels and reserved/inbound flags on workspace view.
...
COMMENT ON VIEW public.v_amazon_listing_workspace IS
  'Denormalized Amazon listing workspace. Profit, compare, health, FBA/FBM (Phase 5C–5F).';
