-- v_amazon_drafts_issues — Drafts / Issues tab read model.
...
COMMENT ON VIEW public.v_amazon_drafts_issues IS
  'Amazon listing drafts with KK product context and open validation/issue counts for admin Drafts / Issues tab.';
