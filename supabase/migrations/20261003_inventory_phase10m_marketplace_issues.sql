-- Phase 10M — Marketplace refund/cancel issue groups (extends v_inventory_issues).
...
COMMENT ON VIEW public.v_inventory_issues IS
  'Grouped inventory issues including live bundle return/RMA workflow + Stripe/marketplace refund guidance (Phase 10M).';
