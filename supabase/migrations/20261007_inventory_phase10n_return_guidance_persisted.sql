-- Phase 10N — Return guidance prefers persisted marketplace observations.
...
COMMENT ON VIEW public.v_inventory_bundle_component_return_guidance IS
  'Phase 10N: persisted marketplace observations preferred + Stripe/marketplace guidance (no auto-restock).';
