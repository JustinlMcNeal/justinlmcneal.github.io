-- Phase 5C: KK vs Amazon price comparison fields on workspace view.
...
COMMENT ON VIEW public.v_amazon_listing_workspace IS
  'Denormalized Amazon listing workspace. Stale detection, profit estimates, and KK vs Amazon price comparison (Phase 5C).';
